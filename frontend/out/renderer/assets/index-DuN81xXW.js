...
function App() {
  const [unreachable, setUnreachable] = reactExports.useState(false);
  reactExports.useEffect(() => {
    let cancelled = false;
    let timer;
    const check = () => {
      fetch(BACKEND_URL, { method: "HEAD" }).then(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.status, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: unreachable ? "Inertia backend is not reachable — retrying…" : "Connecting to Inertia…" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      "Make sure ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "make dev" }),
      " is running in the backend."
    ] })
  ] });
}
